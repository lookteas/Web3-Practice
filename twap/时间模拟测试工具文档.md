...
#### 1. 运行所有时间模拟测试
```bash
forge test --match-test "testIrregular|testHighFrequency|testMarketHours|testMultiToken|testExtreme|testBull|testBear|testSideways|testFlash|testNewToken|testMarketManipulation" -vv
```
...
Logs:
  Bear market TWAP: 8068947368421052631
  Price decline: 19 %

[PASS] testBullMarketScenario() (gas: 2305753)
Logs:
  Bull market TWAP: 1425071428571428571
  Price appreciation: 42 %

[PASS] testExtremeTimeJumps() (gas: 282533)
Logs:
  Extreme time jumps TWAP: 1000000000000000000

[PASS] testFlashCrashRecoveryScenario() (gas: 1255690)
Logs:
  Flash crash scenario TWAP: 1604285714285714285
  Normal price: 2000000000000000000
  Crash price: 400000000000000000

[PASS] testHighFrequencyTrading() (gas: 2310654)
Logs:
  High frequency trading TWAP: 999642857142857142

[PASS] testIrregularTimeIntervals() (gas: 508597)
Logs:
  Irregular intervals TWAP: 1030434782608695652

[PASS] testMarketHoursSimulation() (gas: 3429292)
Logs:
  Weekly market hours TWAP: 1239514563106796116

[PASS] testMarketManipulationScenario() (gas: 2354311)
Logs:
  Normal period TWAP: 2993181818181818181
  Manipulation period TWAP: 6310000000000000000
  Overall TWAP: 3585714285714285714

[PASS] testMultiTokenConcurrentTrading() (gas: 2852181)
Logs:
  Token 0 TWAP: 1225000000000000000
  Token 1 TWAP: 2900000000000000000
  Token 2 TWAP: 837500000000000000

[PASS] testNewTokenListingScenario() (gas: 12656368)
Logs:
  New token listing TWAP: 1825554781289827
  Listing price: 10000000000000000
  Final price: 1216696403287728

[PASS] testSidewaysMarketScenario() (gas: 4613951)
Logs:
  Sideways market TWAP: 4852542372881355932
  Base price: 5000000000000000000
...
#### 3. 运行精度验证测试
```bash
forge test --match-test "testTWAPCalculationPrecision|testBoundaryTimeTWAP|testLargeValueTWAP|testConstantPriceTWAP" -vv
```
...
#### 2. 运行测试并输出详细日志
```bash
forge test --match-test testBullMarketScenario -vvvv
```

#### 3. 运行测试并分析gas使用情况
```bash
forge test --match-test testHighFrequencyTrading --gas-report -vv
```
